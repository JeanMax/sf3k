...
int http_req(void)
{
    ...
    static EXAMPLE_HTTP_REQUEST_T req = {0};  //TODO: extract
    req.hostname = HOST;
    req.url = URL_REQUEST;
    req.headers_fn = http_client_header_print_fn;  //TODO: extract
    req.recv_fn = http_client_receive_print_fn;  //TODO: extract
